        ...
        <div className="form-container">
          <form onSubmit={handleSubmit}>
            <div className="from-elements-container">
              <div className="input-banner-container input-upload-image-container" style={{display: "flex", flexDirection: "row", gap: "0.8rem", marginBottom: "1rem", justifyContent: "space-between", alignItems: "center", paddingLeft: "2rem"}}>
              ...
              <div className="title-input-container">
                ...
                <input type="text" name="name" id="name" placeholder={t("My Pile 01")} required value={pileFormData.name} onChange={handleChange} />
              </div>

              <div className="folder-input-container">
                <label htmlFor="folder-selection">{t("Folder")} <span>*</span></label>
              ...
              <div className="pile-type-input-container">
                <label htmlFor="pile_type_id">{t("Pile Type")} <span>*</span></label>
              ...
              <div className="dead-line-input-container">
                <label htmlFor="dead_line">{t("Deadline")}</label>
            ...
            <div className="form-buttons">
              <Link to="../folders">{t("Cancel")}</Link>
              <button className="create-button" style={uploadProgress !== 0 ? { background: "#CCCCCC" } : null} disabled={LoadingStatus || uploadProgress !== 0}>{ LoadingStatus == true ? `${t("Typing")}...` : `${t("Create")}` }</button>
            </div>
          </form>
        </div>
      </div>
